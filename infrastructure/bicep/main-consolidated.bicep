// ============================================================
//  KayCare LIS — Azure Infrastructure (single-file, Portal-deployable)
...
param appName string = 'kaycare-lis'

@description('Azure region for all resources')
param location string = 'southafricanorth'

@description('SQL Server administrator login')
param sqlAdminLogin string = 'kaycarelis_admin'
...
var sqlDbName     = 'KayCareLISDb'
var storageName   = replace('${replace(appName, '-', '')}${environment}stor', '-', '')
...
var connString = 'Server=tcp:${sqlServer.properties.fullyQualifiedDomainName},1433;Initial Catalog=${sqlDbName};Persist Security Info=False;User ID=${sqlAdminLogin};Password=${sqlAdminPassword};MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;'
