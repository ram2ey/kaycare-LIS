...
public class BillConfiguration : IEntityTypeConfiguration<Bill>
{
    public void Configure(EntityTypeBuilder<Bill> builder)
    {
        ...
        builder.Property(b => b.BalanceDue)
            ...
            .HasComputedColumnSql("[TotalAmount] + [AdjustmentTotal] - [DiscountAmount] - [PaidAmount]", stored: true);
        ...
        builder.HasOne(b => b.CreatedBy).WithMany().HasForeignKey(b => b.CreatedByUserId).OnDelete(DeleteBehavior.Restrict);
    }
}
