...
public class PatientConfiguration : IEntityTypeConfiguration<Patient>
{
    public void Configure(EntityTypeBuilder<Patient> builder)
    {
        ...
        builder.Property(p => p.NationalId).HasMaxLength(500);
        builder.Property(p => p.Email).HasMaxLength(500);
        builder.Property(p => p.PhoneNumber).HasMaxLength(500);
        builder.Property(p => p.AlternatePhone).HasMaxLength(20);
        builder.Property(p => p.AddressLine1).HasMaxLength(1000);
        ...
        builder.Property(p => p.CreatedAt).HasColumnName("RegisteredAt").HasDefaultValueSql("SYSUTCDATETIME()");
