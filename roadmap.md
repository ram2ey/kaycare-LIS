...
- [x] **2.2. Interactive Image Manipulation**:
...
- [x] **3.1. Developer/Simulator Endpoint**:
...
- [x] **3.2. HL7 Simulator Frontend Panel**:
...
- [x] **5.1. Global Font and Styling Tokens**:
...
- [x] **5.3. Scrollbar & Border styling**:
